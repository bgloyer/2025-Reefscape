...
public final class ElevatorConstants {
    ...
    public static final double TopAlgGrab = 0.4;
    ...
    public static final double OffsetL2 = 0.11;
    public static final double OffsetL3 = 0.513;
    public static final double OffsetL4 = 1.26;
