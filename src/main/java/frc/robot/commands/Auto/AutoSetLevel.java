...
public class AutoSetLevel extends SequentialCommandGroup {
    
    

    public AutoSetLevel(Level level, CoralMaster coralMaster, CommandXboxController controller) {
            addCommands(
                ...
                Commands.waitUntil(coralMaster::onTarget),
                new AutoScore(coralMaster).onlyIf(() -> level.isReefScoringPosition)  
            );
    }
}
